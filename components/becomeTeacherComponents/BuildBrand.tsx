...
export default function BuildBrand() {
    return (
        <div className="h-1/2 md:w-1/2 pb-10 w-screen  bg-slate-200 rounded-l-full rounded-t-full drop-shadow-md flex flex-col animate__fadeInTopLeft animate__animated  animate__slower">
            <div className="md:text-3xl text-2xl  text-gray-900 font-bold mt-14 ml-12  md:ml-56  drop-shadow-sm">
                Build Your Brand
            </div>
